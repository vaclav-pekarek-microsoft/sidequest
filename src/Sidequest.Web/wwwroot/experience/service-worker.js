...
const cacheName = "sidequest-public-experience-v3";
const fallback = "/experience/offline.html";
const assets = [
    fallback, "/experience/offline.css?v=1", "/experience/offline.js?v=2",
    "/experience/snapshot-store.js?v=1", "/experience/refresh.js?v=1", "/experience/manifest.webmanifest?v=2",
    "/experience/icon.svg?v=2", "/experience/icon-192.png?v=2", "/experience/icon-512.png?v=2"
];
