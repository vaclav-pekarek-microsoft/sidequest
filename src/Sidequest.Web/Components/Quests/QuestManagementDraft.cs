...
/// <param name="Action">Selected management action restored with retained input; selecting an action alone does not establish a stale-version fence.</param>
public sealed record QuestManagementDraft(string SelectedPerson = "", string Reason = "", string Action = "");
