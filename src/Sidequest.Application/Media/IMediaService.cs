...
public interface IMediaService
{
    ...
    /// <param name="expectedVersion">Nonempty Base64 Quest rowversion from the editor; concurrent changes are never overwritten.</param>
    ...
    public Task<CoverUpdate> UploadCoverAsync(Guid questId, string expectedVersion, Stream content,
    ...
    /// <param name="expectedVersion">Nonempty Base64 Quest rowversion protecting against concurrent edits.</param>
    ...
    public Task<CoverUpdate> RemoveCoverAsync(Guid questId, string expectedVersion,
        CancellationToken cancellationToken = default);
